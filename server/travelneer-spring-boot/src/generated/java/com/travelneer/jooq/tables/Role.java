...
public class Role extends TableImpl<RoleRecord> {
    ...
    private static final long serialVersionUID = -1419840840;

    /**
     * The reference instance of <code>travelneer.role</code>
     */
    ...
    /**
     * The column <code>travelneer.role.id</code>.
     */
    public final TableField<RoleRecord, Byte> ID = createField("id", org.jooq.impl.SQLDataType.TINYINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>travelneer.role.name</code>.
     */
    public final TableField<RoleRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(30).nullable(false), this, "");

    /**
     * Create a <code>travelneer.role</code> table reference
     */
    public Role() {
    ...
    /**
     * Create an aliased <code>travelneer.role</code> table reference
     */
     ...
     */
    @Override
    public Identity<RoleRecord, Byte> getIdentity() {
