...
public class Indexes {
    ...
    public static final Index COUNTRY_FOLLOWS_FK_COUNTRY_FOLLOWS_COUNTRY_CODE = Indexes0.COUNTRY_FOLLOWS_FK_COUNTRY_FOLLOWS_COUNTRY_CODE;
    public static final Index COUNTRY_FOLLOWS_PRIMARY = Indexes0.COUNTRY_FOLLOWS_PRIMARY;
    public static final Index FAVOURITES_FK_FAVOURITES_POST_ID = Indexes0.FAVOURITES_FK_FAVOURITES_POST_ID;
    public static final Index FAVOURITES_PRIMARY = Indexes0.FAVOURITES_PRIMARY;
    public static final Index POST_FK_POST_COUNTRY_CODE = Indexes0.POST_FK_POST_COUNTRY_CODE;
    public static final Index POST_FK_POST_USER_ID = Indexes0.POST_FK_POST_USER_ID;
    ...
    public static final Index USER_ROLES_FK_USER_ROLES_ROLE_ID = Indexes0.USER_ROLES_FK_USER_ROLES_ROLE_ID;
    ...
    private static class Indexes0 {
        ...
        public static Index COUNTRY_FOLLOWS_FK_COUNTRY_FOLLOWS_COUNTRY_CODE = Internal.createIndex("fk_country_follows_country_code", CountryFollows.COUNTRY_FOLLOWS, new OrderField[] { CountryFollows.COUNTRY_FOLLOWS.COUNTRY_CODE }, false);
        public static Index COUNTRY_FOLLOWS_PRIMARY = Internal.createIndex("PRIMARY", CountryFollows.COUNTRY_FOLLOWS, new OrderField[] { CountryFollows.COUNTRY_FOLLOWS.USER_ID, CountryFollows.COUNTRY_FOLLOWS.COUNTRY_CODE }, true);
        public static Index FAVOURITES_FK_FAVOURITES_POST_ID = Internal.createIndex("fk_favourites_post_id", Favourites.FAVOURITES, new OrderField[] { Favourites.FAVOURITES.POST_ID }, false);
        ...
        public static Index POST_FK_POST_COUNTRY_CODE = Internal.createIndex("fk_post_country_code", Post.POST, new OrderField[] { Post.POST.COUNTRY_CODE }, false);
        public static Index POST_FK_POST_USER_ID = Internal.createIndex("fk_post_user_id", Post.POST, new OrderField[] { Post.POST.AUTHOR_ID }, false);
        ...
        public static Index USER_ROLES_FK_USER_ROLES_ROLE_ID = Internal.createIndex("fk_user_roles_role_id", UserRoles.USER_ROLES, new OrderField[] { UserRoles.USER_ROLES.ROLE_ID }, false);
