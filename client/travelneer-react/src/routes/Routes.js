    ...
    render() {
        return (
            <Switch>
                ...
                <Route path="/request-password-reset" exact render={(props) => <ForgotPassword {...props} />} />
                <Route path="/secure-password-reset/:token" exact render={(props) => <ChangePassword {...props} />} />
            </Switch>
        )
    }
}