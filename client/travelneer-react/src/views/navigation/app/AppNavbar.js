        ...
        return (
            <div className={`navbar navbar-fixed-top ${styles.navbar}`}>
                <div className="container">               
                    ...
                    <div className={`btn col-sm-2 col-xs-3 col-md-2 col-l-2 col-xl-2`} onClick={() => this.props.navigateTo('/me') } >
                    ...
                    <div className={`btn col-sm-2 col-xs-3 col-md-2 col-l-2 col-xl-2`} onClick={() => this.props.navigateTo('/countries') } >
                        <img className={styles.img} alt='globe' src={globe} />
                    </div>
                    <div className={`btn col-sm-2 col-xs-3 col-md-2 col-l-2 col-xl-2`} onClick={() => this.props.navigateTo('/feed') } >
